...
describe("The test harness", () => {
  describe("the factory function", () => {
    it("should return an appropriately structured object", () => {
      ...
      expect(check.object(harn.transportWrapper)).toBe(true);
      expect(check.function(harn.transportWrapper.state)).toBe(true);
      expect(check.function(harn.transportWrapper.start)).toBe(true);
      expect(check.function(harn.transportWrapper.stop)).toBe(true);
      expect(check.function(harn.transportWrapper.send)).toBe(true);
      expect(check.function(harn.transportWrapper.disconnect)).toBe(true);
      expect(check.function(harn.transportWrapper.on)).toBe(true);
      expect(check.function(harn.transportWrapper.emit)).toBe(true);
      expect(check.function(harn.transportWrapper.mockClear)).toBe(true);
